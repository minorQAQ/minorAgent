...
def _refresh_globals():
    ...
    global LLM_CONTEXT_WINDOW, MINI_COMPRESS_RATE, HARD_COMPRESS_RATE, CURRENT_TURNS
    ...
    MINI_COMPRESS_RATE = float(os.getenv("MINI_COMPRESS_RATE", 0.4))
    HARD_COMPRESS_RATE = float(os.getenv("HARD_COMPRESS_RATE", 0.7))
    CURRENT_TURNS = int(os.getenv("CURRENT_TURNS", 4))
